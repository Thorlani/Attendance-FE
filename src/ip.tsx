...
import { AuthAction, RedoAction, DestAction } from "./redux/AuthAction";
...
const IntellectualProperty = () => {
  ...
  const handleSubmit = (event: { preventDefault: () => void }) => {
    ...
    axios
      .post("https://attendance-be.vercel.app/api/postIp", formDatas)
      .then((res) => {
        setLoading(false);
  ...
  const {
    ...
    axios.get("https://attendance-be.vercel.app/api/intellectual")
  );
  ...
  const searchMatric = (e: { preventDefault: () => void }) => {
    ...
    if (!searchField) {
      ...
      axios
        .get(
          `https://attendance-be.vercel.app/api/intellectual/find/${searchField}`
        )
        .then((res) => {
